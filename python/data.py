...
LINES = {
    ...
    'butterflies': (
        ...
        ("PRISONER IN THE WOOD", "A COMMODORE AT TRAFALGAR", "EGGS MUST BE BROKEN", "A VELVET SUIT", "A TYRANT IS BORN"),
        ("THE ADMIRALS PARTY", "APRICOTS AND NECTARINES", "A BANQUET OF KINGS", "DEATH OF A KING", "A KING IS CROWNED", "HOW DO KING TOSH"),
        ("A WIDOW AND CHILDREN", "ENTER THE HERO", "THE GENIE IN THE CHURCH", "TRIAL BEFORE THE COUNCIL"),
        ("THE DISTANT MOUNTAINS", "BEHOLD THE HEIR APPARENT", "CHIEF OF THE REBELS", "THE OLD RULER IS BANISHED"),
        ...
        ("JOURNEY BY SEA", "THE VERDICT IS DEATH", "AN ARDUOUS JOURNEY", "FOUNDER OF A NATION"),
        ("LAND OF THE CYCLOPS", "A PET TAKES FLIGHT", "A PEACEFUL CONCLUSION", "SHE WIELDS POWER", "AMONG HIS OWN PEOPLE"),
        ["key goes here"]
    ),
